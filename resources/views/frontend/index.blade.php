                ...
                <div class="container">
                    <div class="row cnt-block">
                        ...
                        <div class="col-md-6 mobile-img">
                            <figure class="animated fadeInUp delay-06s"><img src="img/web_vector.png" class="img-slide1" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
            <div class="banner banner2 slide2">
                <div class="container">
                    <div class="row cnt-block">
                        ...
                        <div class="col-md-6 mobile-img">
                            <figure class="animated fadeInDown delay-06s"><img src="img/niche_vecor2.png" class="img-fluid" alt=""></figure>
                            <figure class="animated fadeInRight delay-06s"><img src="img/niche_vecor4.png" class="img-slide2-02" alt=""></figure>
                            <figure class="animated fadeInUp delay-06s"><img src="img/niche_vector1.png" class="img-fluid" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
            <div class="banner banner3 slide3">
                <div class="container">
                    <div class="row cnt-block">
                        ...
                        <div class="col-md-6 mobile-img">
                            <figure class="animated fadeInLeft delay-06s"><img src="img/service_vector.png" class="img-fluid" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="technologies-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <figure class="img"><img src="img/about-briskbraintech-business.png" class="img-fluid" alt=""></figure>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="client-speak carousel1 padding-lg">
        <div class="container">
            ...
            <ul class="speak-listing opt1 owl-carousel">
                <li>
                    <div class="inner">
                        <figure><img src="img/unknown.png" class="img-fluid rounded-circle" alt=""></figure>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="img/profile_logo_26535677.jpg" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                ...
                <li>
                    <div class="inner">
                        <figure><img src="img/profile_logo_22073579.jpg" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                            <h4>Testunity</h4>
                            <span class="designation">USA</span> 
                ...
                <li>
                    <div class="inner">
                        <figure><img src="img/profile_logo_15562219.jpg" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                            <h4>Leetdave</h4>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="img/profile_logo_24696770.jpg" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                            <h4>Acheros</h4>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="img/profile_logo_19399235.jpg" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                ...
                <li>
                    <div class="inner">
                        <figure><img src="img/profile_logo_7214273.jpg" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                            <h4>Pal Sidhu</h4>
                            <span class="designation">Australia</span> 
            ...
            <ul class="row portfolio clearfix isotopeContainer">
                <li class="col-6 col-md-4 isotopeSelector business">
                    <div class="inner">
                        ...
                        <figure><img src="img/portfoliyo/01.png" class="img-responsive" alt=""></figure>
                    </div>
                </li>
                <li class="col-6 col-md-4 isotopeSelector company">
                    <div class="inner">
                        ...
                        <figure><img src="img/portfoliyo/02.png" class="img-responsive" alt=""></figure>
                    </div>
                </li>
                <li class="col-6 col-md-4 isotopeSelector business">
                    <div class="inner">
                        ...
                        <figure><img src="img/portfoliyo/03.png" class="img-responsive" alt=""></figure>
                    </div>
                </li>
                <li class="col-6 col-md-4 isotopeSelector yiitwo">
                    <div class="inner">
                        ...
                        <figure><img src="img/portfoliyo/04.png" class="img-responsive" alt=""></figure>
                    </div>
                </li>
                <li class="col-6 col-md-4 isotopeSelector webapp software">
                    <div class="inner">
                        ...
                        <figure><img src="img/portfoliyo/05.png" class="img-responsive" alt=""></figure>
                    </div>
                </li>
                <li class="col-6 col-md-4 isotopeSelector company">
                    <div class="inner">
                        ...
                        <figure><img src="img/portfoliyo/06.png" class="img-responsive" alt=""></figure>
                    </div>
                </li>
                <li class="col-6 col-md-4 isotopeSelector wordpress">
                    <div class="inner">
                        ...
                        <figure><img src="img/portfoliyo/07.png" class="img-responsive" alt=""></figure>
                    </div>
                </li>
                <li class="col-6 col-md-4 isotopeSelector software">
                    <div class="inner">
                        ...
                        <figure><img src="img/portfoliyo/08.png" class="img-responsive" alt=""></figure>
                    </div>
                </li>
                <li class="col-6 col-md-4 isotopeSelector company webapp">
                    <div class="inner">
                        ...
                        <figure><img src="img/portfoliyo/09.png" class="img-responsive" alt=""></figure>
                    </div>
                </li>
            </ul>
