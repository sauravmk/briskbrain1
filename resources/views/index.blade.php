                ...
                <div class="container">
                    <div class="row cnt-block">
                        ...
                        <div class="col-md-6 mobile-img">
                            <figure class="animated fadeInUp delay-06s"><img src="{{asset('img/web_vector.png')}}" class="img-slide1" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
            <div class="banner banner2 slide2">
                <div class="container">
                    <div class="row cnt-block">
                        ...
                        <div class="col-md-6 mobile-img">
                            <figure class="animated fadeInDown delay-06s"><img src="{{asset('img/niche_vecor2.png')}}" class="img-fluid" alt=""></figure>
                            <figure class="animated fadeInRight delay-06s"><img src="{{asset('img/niche_vecor4.png')}}" class="img-slide2-02" alt=""></figure>
                            <figure class="animated fadeInUp delay-06s"><img src="{{asset('img/niche_vector1.png')}}" class="img-fluid" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
            <div class="banner banner3 slide3">
                <div class="container">
                    <div class="row cnt-block">
                        ...
                        <div class="col-md-6 mobile-img">
                            <figure class="animated fadeInLeft delay-06s"><img src="{{asset('img/service_vector.png')}}" class="img-fluid" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="technologies-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <figure class="img"><img src="{{asset('img/about-briskbraintech-business.png')}}" class="img-fluid" alt=""></figure>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="client-speak carousel1 padding-lg">
        <div class="container">
            ...
            <ul class="speak-listing opt1 owl-carousel">
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{asset('img/profile_logo_26535677.jpg')}}" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{asset('img/profile_logo_22073579.jpg')}}" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                            <h4>Testunity</h4>
                            <span class="designation">USA</span>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{asset('img/profile_logo_15562219..jpg')}}" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                            <h4>Leetdave</h4>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{asset('img/profile_logo_24696770..jpg')}}" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                            <h4>Acheros</h4>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{asset('img/profile_logo_19399235..jpg')}}" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{asset('img/profile_logo_7214273..jpg')}}" class="img-fluid rounded-circle" alt=""></figure>
                        <span class="icon-quote"></span>
                        <div class="client-detail">
                            <h4>Pal Sidhu</h4>
                            <span class="designation">Australia</span>
